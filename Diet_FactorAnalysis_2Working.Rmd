...
svyload.ua <- as.data.frame(unclass(svyload.ua))
svyload.ua <- as.matrix(svyload.ua )

svyload.a <- as.data.frame(unclass(svyload.a))
svyload.a <- as.matrix(svyload.a)

#prepare foods for matrix mult
fooz <- scale(fooz, scale = TRUE)
fooz <- as.matrix(fooz)
svyscores.ua <- (fooz %*% svyload.ua)
svyscores.a <- (fooz %*% svyload.a)
...
quantile.ua1 <- as.factor(ntile(diet$ua.dp1, 4))
levels(quantile.ua1) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.ua1 <- quantile.ua1

quantile.ua2 <- as.factor(ntile(diet$ua.dp2, 4))
levels(quantile.ua2) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.ua2 <- quantile.ua2

quantile.ua3 <- as.factor(ntile(diet$ua.dp3, 4))
levels(quantile.ua3) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.ua3 <- quantile.ua3

quantile.ua4 <- as.factor(ntile(diet$ua.dp4, 4))
levels(quantile.ua4) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.ua4 <- quantile.ua4

#adjusted quantiles

quantile.a1 <- as.factor(ntile(diet$a.dp1, 4))
levels(quantile.a1) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.a1 <- quantile.a1

quantile.a2 <- as.factor(ntile(diet$a.dp2, 4))
levels(quantile.a2) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.a2 <- quantile.a2

quantile.a3 <- as.factor(ntile(diet$a.dp3, 4))
levels(quantile.a3) = c("lowest", "2nd quant", "3rd quant", "highest")
diet$quantile.a3 <- quantile.a3

quantile.a4 <- as.factor(ntile(diet$a.dp4, 4))
levels(quantile.a4) = c("lowest", "2nd quant", "3rd quant", "highest")
...
dsub5 <- subset(diet_sur, (diet$ageNum > 45) & (diet$sr_od == 0))
```
...
#unadjusted dps by quantile and obj_od
ua.yf.fit1<- summary(svyglm(obj_od ~ quantile.ua1  + race + bmi + smoker + incpov_ratio, design = dsub2, family = "quasibinomial"))
ua.yf.sum1 <-summary(ua.ym.fit1)$coefficients[1:4,]

ua.yf.fit2<- summary(svyglm(obj_od ~ quantile.ua2  + race + bmi + smoker + incpov_ratio, design = dsub2, family = "quasibinomial"))
ua.yf.sum2 <-summary(ua.ym.fit2)$coefficients[1:4,]

ua.yf.fit3<- summary(svyglm(obj_od ~ quantile.ua3  + race + bmi + smoker + incpov_ratio, design = dsub2, family = "quasibinomial"))
ua.yf.sum3 <-summary(ua.ym.fit3)$coefficients[1:4,]

ua.yf.fit4<- summary(svyglm(obj_od ~ quantile.ua4 + race + bmi + smoker + incpov_ratio , design = dsub2, family = "quasibinomial"))
ua.yf.sum4 <-summary(ua.ym.fit4)$coefficients[1:4,]
...
#unadjusted dps by quantile and obj_od
ua.om.fit1<- summary(svyglm(obj_od ~ quantile.ua1  + race + bmi + smoker + incpov_ratio, design = dsub3, family = "quasibinomial"))

ua.om.fit2<- summary(svyglm(obj_od ~ quantile.ua2  + race + bmi + smoker + incpov_ratio, design = dsub3, family = "quasibinomial"))

ua.om.fit3<- summary(svyglm(obj_od ~ quantile.ua3  + race + bmi + smoker + incpov_ratio, design = dsub3, family = "quasibinomial"))

ua.om.fit4<- summary(svyglm(obj_od ~ quantile.ua4 + race + bmi + smoker + incpov_ratio , design = dsub3, family = "quasibinomial"))

#display significant

rez.om <-rbind(ua.om.fit1$coefficients[1:4,],ua.om.fit2$coefficients[1:4,],ua.om.fit3$coefficients[1:4,],ua.om.fit4$coefficients[1:4,])
...
#unadjusted dps by quantile and obj_od
ua.of.fit1<- summary(svyglm(obj_od ~ quantile.ua1  + race + bmi + smoker + incpov_ratio, design = dsub4, family = "quasibinomial"))

ua.of.fit2<- summary(svyglm(obj_od ~ quantile.ua2  + race + bmi + smoker + incpov_ratio, design = dsub4, family = "quasibinomial"))

ua.of.fit3<- summary(svyglm(obj_od ~ quantile.ua3  + race + bmi + smoker + incpov_ratio, design = dsub4, family = "quasibinomial"))

ua.of.fit4<- summary(svyglm(obj_od ~ quantile.ua4 + race + bmi + smoker + incpov_ratio , design = dsub4, family = "quasibinomial"))

#display significant

rez.of <-rbind(ua.of.fit1$coefficients[1:4,],ua.of.fit2$coefficients[1:4,],ua.of.fit3$coefficients[1:4,],ua.of.fit4$coefficients[1:4,])
...
#DP1
ua1.ym.subset <- filter(diet, (diet$ageNum <= 60) & (diet$gender == 0))
ua1.ym.table <- table(ua1.ym.subset$quantile.ua1,ua1.ym.subset$obj_od)
ua1.ym.plot.x <- c(1,2,3,4)
ua1.ym.plot.y <- ua1.ym.table[,2]/ua1.ym.table[,1]

ua1.yf.subset <- filter(diet, (diet$ageNum <= 60) & (diet$gender == 1))
ua1.yf.table <- table(ua1.yf.subset$quantile.ua1,ua1.yf.subset$obj_od)
ua1.yf.plot.x <- c(1,2,3,4)
ua1.yf.plot.y <- ua1.yf.table[,2]/ua1.yf.table[,1]

ua1.om.subset <- filter(diet, (diet$ageNum > 60) & (diet$gender == 0))
ua1.om.table <- table(ua1.om.subset$quantile.ua1,ua1.om.subset$obj_od)
ua1.om.plot.x <- c(1,2,3,4)
ua1.om.plot.y <- ua1.om.table[,2]/ua1.om.table[,1]

ua1.of.subset <- filter(diet, (diet$ageNum > 60) & (diet$gender == 1))
ua1.of.table <- table(ua1.of.subset$quantile.ua1,ua1.of.subset$obj_od)
ua1.of.plot.x <- c(1,2,3,4)
ua1.of.plot.y <- ua1.of.table[,2]/ua1.of.table[,1]



plot(ua1.ym.plot.x , ua1.ym.plot.y , type = "b", frame = FALSE, pch = 19, 
     col = "red", xlab = "x", ylab = "y", ylim = c(0,1))

lines(ua1.yf.plot.x, ua1.yf.plot.y, pch = 18, col = "blue", type = "b", lty = 2)

lines(ua1.om.plot.x, ua1.om.plot.y, pch = 18, col = "green", type = "b", lty = 2)

lines(ua1.of.plot.x, ua1.of.plot.y, pch = 18, col = "black", type = "b", lty = 2)
...
#unadjusted dps by quantile and obj_od
a.ym.fit1<- summary(svyglm(obj_od ~ quantile.a1 + race + bmi + smoker + incpov_ratio, design = dsub1, family = "quasibinomial"))

a.ym.fit2<- summary(svyglm(obj_od ~ quantile.a2  + race + bmi + smoker + incpov_ratio, design = dsub1, family = "quasibinomial"))

a.ym.fit3<- summary(svyglm(obj_od ~ quantile.a3 + race + bmi + smoker + incpov_ratio, design = dsub1, family = "quasibinomial"))

a.ym.fit4<- summary(svyglm(obj_od ~ quantile.a4 + race + bmi + smoker + incpov_ratio , design = dsub1, family = "quasibinomial"))



rez.ym <-rbind(a.ym.fit1$coefficients[1:4,],a.ym.fit2$coefficients[1:4,],a.ym.fit3$coefficients[1:4,],a.ym.fit4$coefficients[1:4,])
...
#unadjusted dps by quantile and obj_od
a.yf.fit1<- summary(svyglm(obj_od ~ quantile.a1  + race + bmi + smoker + incpov_ratio, design = dsub2, family = "quasibinomial"))

a.yf.fit2<- summary(svyglm(obj_od ~ quantile.a2  + race + bmi + smoker + incpov_ratio, design = dsub2, family = "quasibinomial"))

a.yf.fit3<- summary(svyglm(obj_od ~ quantile.a3  + race + bmi + smoker + incpov_ratio, design = dsub2, family = "quasibinomial"))

a.yf.fit4<- summary(svyglm(obj_od ~ quantile.a4 + race + bmi + smoker + incpov_ratio , design = dsub2, family = "quasibinomial"))

#display significant

rez.yf <-rbind(a.yf.fit1$coefficients[1:4,],a.yf.fit2$coefficients[1:4,],a.yf.fit3$coefficients[1:4,],a.yf.fit4$coefficients[1:4,])
...
#unadjusted dps by quantile and obj_od
a.om.fit1<- summary(svyglm(obj_od ~ quantile.a1  + race + bmi + smoker + incpov_ratio, design = dsub3, family = "quasibinomial"))

a.om.fit2<- summary(svyglm(obj_od ~ quantile.a2  + race + bmi + smoker + incpov_ratio, design = dsub3, family = "quasibinomial"))

a.om.fit3<- summary(svyglm(obj_od ~ quantile.a3  + race + bmi + smoker + incpov_ratio, design = dsub3, family = "quasibinomial"))

a.om.fit4<- summary(svyglm(obj_od ~ quantile.a4 + race + bmi + smoker + incpov_ratio , design = dsub3, family = "quasibinomial"))

#display significant

rez.om <-rbind(a.om.fit1$coefficients[1:4,],a.om.fit2$coefficients[1:4,],a.om.fit3$coefficients[1:4,],a.om.fit4$coefficients[1:4,])
...
#unadjusted dps by quantile and obj_od
a.of.fit1<- summary(svyglm(obj_od ~ quantile.a1  + race + bmi + smoker + incpov_ratio, design = dsub4, family = "quasibinomial"))

a.of.fit2<- summary(svyglm(obj_od ~ quantile.a2  + race + bmi + smoker + incpov_ratio, design = dsub4, family = "quasibinomial"))

a.of.fit3<- summary(svyglm(obj_od ~ quantile.a3  + race + bmi + smoker + incpov_ratio, design = dsub4, family = "quasibinomial"))

a.of.fit4<- summary(svyglm(obj_od ~ quantile.a4 + race + bmi + smoker + incpov_ratio , design = dsub4, family = "quasibinomial"))

#display significant

rez.of <-rbind(a.of.fit1$coefficients[1:4,],a.of.fit2$coefficients[1:4,],a.of.fit3$coefficients[1:4,],a.of.fit4$coefficients[1:4,])
