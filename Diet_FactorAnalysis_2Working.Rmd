...
ua.ym.fit1<- summary(svyglm(obj_od ~ quantile.ua1 + race + bmi + smoker + incpov_ratio, design = dsub1, family = "quasibinomial"))

ua.ym.fit2<- summary(svyglm(obj_od ~ quantile.ua2  + race + bmi + smoker + incpov_ratio, design = dsub1, family = "quasibinomial"))

ua.ym.fit3<- summary(svyglm(obj_od ~ quantile.ua3 + race + bmi + smoker + incpov_ratio, design = dsub1, family = "quasibinomial"))

ua.ym.fit4<- summary(svyglm(obj_od ~ quantile.ua4 + race + bmi + smoker + incpov_ratio , design = dsub1, family = "quasibinomial"))



rez.ym <-rbind(ua.ym.fit1$coefficients[1:4,],ua.ym.fit2$coefficients[1:4,],ua.ym.fit3$coefficients[1:4,],ua.ym.fit4$coefficients[1:4,])
...
rez.yf <-rbind(ua.yf.fit1$coefficients[1:4,],ua.yf.fit2$coefficients[1:4,],ua.yf.fit3$coefficients[1:4,],ua.yf.fit4$coefficients[1:4,])
